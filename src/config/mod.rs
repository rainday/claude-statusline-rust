...
impl Default for SegmentsConfig {
    fn default() -> Self {
        Self { enabled: defaults::enabled_segments() }
    }
}

impl Default for ThemeConfig {
    fn default() -> Self {
        Self { name: defaults::theme_name(), colors: None }
    }
}

impl Default for UsageConfig {
    fn default() -> Self {
        Self { cache_ttl_secs: defaults::cache_ttl() }
    }
}
...
impl Config {
    ...
    pub fn config_path() -> PathBuf {
        ...
        home.join(".claude").join("statusline-rs").join("config.toml")
    }
}
